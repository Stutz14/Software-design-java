...
import utilities.ACStateFactoryRepoPolulator;
...
public class FMCServer {
	...
	public static void main(String[] args) {
		...
		ACStateFactoryRepoPolulator anACStateFactoryPolulator = ACStateFactoryRepoPolulator.getInstance();
		anACStateFactoryPolulator.polulateACStateFactoryRepo();
